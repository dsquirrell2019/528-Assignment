...
public class ServiceObjectFactoryJpaImpl implements ServiceObjectFactory {
    ...
    //private String pricingFile = File.separator + "client" + File.separator +"priceFile.xml";
    
    
    /**
     * Initialises objectFactory
     */
    ...
    public PriceCalculatorDAO getPriceCalculatorDAO() {
        try {
            if(priceCalculatorDAO == null) {
               // priceCalculatorDAO = new PriceCalculatorDAOJaxbImp(pricingDetailsFile);
            }      
        } catch(Exception e) {
