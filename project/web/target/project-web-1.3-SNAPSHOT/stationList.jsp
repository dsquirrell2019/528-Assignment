...
<%
    ...
    } else if ("deleteAllStations".equals(actionString)) {
        try { stationDAO.deleteAll();
        stationList = stationDAO.findAll();
        message = "all stations deleted";
        } catch (Exception e){
            errorMessage = "could not delete stations";
        }

    } else if ("deleteStation".equals(actionString)) {
...
<html>
    ...
    <body>
        ...
        <p>Stations in <%= (zoneString == null) ? "All Zones" : "Zone&nbsp;" + zoneString%></p>
